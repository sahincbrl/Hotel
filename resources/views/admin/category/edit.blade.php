                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form id="editCategory" action="{{route('admin.categories.update',$category)}}" method="post">
                                @method('put')
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ad"
                                               name="name_az" value="{{$category->name_az}}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control">
                                            <option value="1" @selected($category->status==1)>Aktiv</option>
                                            <option value="0" @selected($category->status==0)>Passiv</option>
                                        </select>
                    ...
                    error: function (response) {
                        ...
                        if (result.status == 'validation-error') {
                            $.each(result.errors, function (key, value) {
                                ...
                                $('#editCategory .invalid-feedback[data-input="' + attribute + '"]').addClass('d-block').text(value)
                            })
                        }
                    }
                })
