                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card card-custom gutter-b example example-compact">
                            ...
                            <!--begin::Form-->
                            <form id="addMenu" action="{{route('admin.menus.store')}}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ad" name="name_az"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Name" name="name_en"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Название" name="name_ru"/>
                    ...
                    error: function (response) {
                        ...
                        if (result.status == 'validation-error') {
                            $.each(result.errors, function (key, value) {
                                ...
                                $('#addMenu .invalid-feedback[data-input="' + attribute + '"]').addClass('d-block').text(value)
                            })
                        }
                    }
                })
